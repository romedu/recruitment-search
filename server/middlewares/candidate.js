...
exports.checkIfEmployer = async (req, res, next) => {
   try {
      ...
      if(currentUser._id != currentPosition.company) throw createError(403, "Unauthorized");
...
exports.checkIfOwner = async (req, res, next) => {
   try {
      ...
      else if(currentUser._id != currentCandidate.userData) throw createError(403, "Unauthorized");
...
exports.checkIfOwnerOrEmployer = async (req, res, next) => {
   try {
      ...
      if(currentUser.isCompany){
         const currentPosition = await Position.findById(req.params.positionId);
         if(!currentPosition) throw createError(404, "Not Found");
         else if(currentUser._id != currentPosition.company) throw createError(403, "Unauthorized");
         next();
      }
      else {
